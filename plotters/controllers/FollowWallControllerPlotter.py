...
class FollowWallControllerPlotter:
    ...
    def draw_active_follow_wall_controller_to_frame(self, frame):
        ...
        if current_state == ControlState.SLIDE_LEFT:
            self._draw_follow_wall_controller_to_frame_by_side(FWDIR_LEFT, frame)
        elif current_state == ControlState.SLIDE_RIGHT:
            self._draw_follow_wall_controller_to_frame_by_side(FWDIR_RIGHT, frame)
        else:
    ...
    def _draw_follow_wall_controller_to_frame_by_side(self, side, frame):
        if side == FWDIR_LEFT:
