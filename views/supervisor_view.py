...
class SupervisorView:
    ...
    def __init__(self, supervisor, robot_geometry):
        ...
        # controller views
        self.go_to_goal_controller_view = GoToGoalControllerView(supervisor)
        self.avoid_obstacles_controller_view = AvoidObstaclesControllerView(supervisor)
        self.gtg_and_ao_controller_view = GTGAndAOControllerView(supervisor)
        self.follow_wall_controller_view = FollowWallControllerView(supervisor)
