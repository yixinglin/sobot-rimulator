...
class SlamView:
    ...
    def __init__(self, slam, frame, viewer):
        # bind the viewer
        self.frame = frame
        self.slam = slam
        self.viewer = viewer
    ...
    def add_landmark(self, landmark):
        obstacle_view = ObstacleView(self.viewer, landmark)
    ...
    def _draw_grid_to_frame(self):
        ...
        # draw the gridlines
        self.frame.add_lines(major_lines_accum,  # draw major gridlines
                                    linewidth=meters_per_pixel,  # roughly 1 pixel
                                    color="black",
                                    alpha=0.2)
        self.frame.add_lines(minor_lines_accum,  # draw minor gridlines
                                    linewidth=meters_per_pixel,  # roughly 1 pixel
                                    color="black",
                                    alpha=0.1)
